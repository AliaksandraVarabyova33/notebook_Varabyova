...
public class InputTerminal {
	...
	public String inputTitle() {
		...
		// added this validation cause found a bug for my eclipse version - empty string left after nextInt() method and scanner read this empty string instead of waiting for user input
